...
pub(crate) use self::{
    ...
    sidebar::{
        ...
        normalized_workspace_scroll, render_sidebar_section_header, sidebar_section_divider_rect,
        sidebar_section_header_rects, sidebar_section_marker_visible, workspace_drop_indicator_row,
